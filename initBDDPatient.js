...
db.medecin.insert({_id : 14, prenom : "Jacques-Henri", nom : "Eyraud", email : "jacky.eyraud@hopital-medecin.fr", listeConsultations : Array(999,123), listePatients : Array()})

db.creneau.insert({"_id" : 1, "date" :"26-02-2022", "heure" : "18H10", "disponibilite" : Boolean(false)})

db.creneau.insert({"_id" : 2, "date" :"27-02-2022", "heure" : "13H", "disponibilite" : Boolean(false)})

db.creneau.insert({"_id" : 3, "date" :"27-02-2022", "heure" : "15H", "disponibilite" : Boolean(false)})
